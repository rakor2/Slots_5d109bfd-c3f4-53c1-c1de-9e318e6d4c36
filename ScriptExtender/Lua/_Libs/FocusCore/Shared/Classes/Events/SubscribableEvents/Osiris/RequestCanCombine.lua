---@class FCRequestCanCombineParams:FCEventParams
...
---@field RequestID
FCParams.RequestCanCombine = FCEventParamsBase:New()

---@param ... string
---@return boolean
function FCParams.RequestCanCombine:HasStatId(...)
...
---@param ... Guid|string
---@return boolean
function FCParams.RequestCanCombine:HasTemplate(...)
...
---@param ... string
---@return boolean
function FCParams.RequestCanCombine:HasGuid(...)
...
---@param ... string
---@return boolean
function FCParams.RequestCanCombine:HasEntity(...)
...
---@class FCEventRequestCanCombine: FCOsirisEventBase
---@field Subscribe fun(self:FCEventRequestCanCombine, callback:fun(e:FCRequestCanCombineParams))
Events.Osiris.RequestCanCombine = FCOsirisEventBase:CreateEvent("FCEventRequestCanCombine", {OsirisEvent = "RequestCanCombine", OsirisArity = 7})
